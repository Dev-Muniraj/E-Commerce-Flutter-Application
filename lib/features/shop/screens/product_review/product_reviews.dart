      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text("Rating and reviews are verified and are from people who use the same type of that you use."),
              ...
              Text("12,126", style: Theme.of(context).textTheme.bodySmall),
